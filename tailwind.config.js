...
export default {
  ...
  theme: {
    extend: {
      /*
        🎨 THEME SYSTEM
        Every color points to a CSS variable defined in src/index.css:
          :root                    → 🍂 Stars Hollow (default, your original look)
          [data-theme='harvard']   → 🎓 Harvard override
        Switching themes = changing ONE attribute on <html>; Tailwind never changes.
      */
      colors: {
